...
##However, Jimmy helped me at the begining of class 
...
#this separates the string and makes it into a list
...
#creates matrix with 5 rows/3 colums using d1 as data
m3
df<- data.frame(m3) 
#converts matrix into data frame do it can be manipulated differently
df
as.logical(df$X2) 
#makes column 2 logical valued
df
as.factor(df$X3) 
#makes colum 3 factor valued
str(df)
```
